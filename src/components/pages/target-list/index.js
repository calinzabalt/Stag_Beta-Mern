...
const Target = props => (
    <>
        <div className="item username">{props.target.username}</div>
        <div className="item description">{props.target.description}</div>
        <div className="item duration">{props.target.duration}</div>
        <div className="item date">{props.target.date.substring(0,10)}</div>
