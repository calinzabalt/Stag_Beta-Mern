...
const Target = props => (
    <>
        <div className="item username"><span className="just_on_mobile">Assigned: </span>{props.target.username}</div>
        <div className="item description"><span className="just_on_mobile">Description: </span>{props.target.description}</div>
        <div className="item duration"><span className="just_on_mobile">Duration: </span>{props.target.duration}</div>
        <div className="item date"><span className="just_on_mobile">Date: </span>{props.target.date.substring(0,10)}</div>
        <div className="item priority" 
            id={props.target.priority === 'low' ? 'low' : props.target.priority === 'medium' ? "medium" : props.target.priority === 'high' ? "high" : null}>
            <span className="just_on_mobile">Priority: </span>{props.target.priority}
        </div>
        <div className="item edit_delete">
    ...
    render(){
        return(
            <div className="Targets_page">
                <div className="table">
                    <ul>
                        <li className="username">Assigned</li>
